...
{{<image-text-row img="/img/members/leandro-villas.png" title="Prof. Dr. Leandro Aparecido Villas">}}

{{</image-text-row>}}

{{<image-text-row img="/img/members/allan-mariano.png" title="Prof. Dr. Allan Mariano">}}
 
{{</image-text-row>}}


# Postdoctoral Researchers
{{<image-text-row img="/img/members/eryck-pedro.png" title="Dr. Eryck Pedro da Silva">}}
 
{{</image-text-row>}}


# Assistant Researchers & Specialists
{{<image-text-row img="/img/members/frances-santos.png" title="Dr. Frances Santos">}}
...
{{<image-text-row img="/img/members/carlos-mazzuco.png" title="Carlos Mazzuco">}}
{{</image-text-row>}}
...
# Software Developers
{{<image-text-row img="/img/members/luciana-oliveira.png" title="Luciana Oliveira">}}
{{</image-text-row>}}

{{<image-text-row img="/img/members/augusto-machado.png" title="Augusto Machado">}}
{{</image-text-row>}}

# Other Former Participants
{{<image-text-row img="/img/members/felipe-barroso.png" title="Felipe Barroso">}}
{{</image-text-row>}}

{{<image-text-row img="/img/members/ana-carmo.png" title="Ana Luiza Regia Angelloti Carmo">}}
{{</image-text-row>}}

{{<image-text-row img="/img/members/lucas-almeida.png" title="Lucas de Almeida">}}
{{</image-text-row>}}

{{<image-text-row img="/img/members/gabriel-mascarenhas.png" title="Gabriel Carvalhais Mascarenhas">}}
{{</image-text-row>}}